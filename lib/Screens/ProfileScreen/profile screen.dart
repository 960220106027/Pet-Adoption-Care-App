          ...
          child: Column(
            children: [
                Center(
                  child: Stack(
                    children: [
                       CircleAvatar(radius: 50,backgroundImage: AssetImage("assets/female.png"),),
                       Positioned(
                        bottom: 2,
                        right: 0,
                ...
                Text("Anusha",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          }, icon:Icon(Icons.pets,size: 30,color: Colors.black,)),
                          SizedBox(width: size.width*0.04,),
                         Text("Adopted Pets",style: TextStyle(fontSize:25,color: Colors.black),),
                       ...
                       Row(
                        ...
                        children: [
                          ...
                          }, icon:Icon(Icons.alarm,size: 30,color: Colors.black,)),
                        SizedBox(width: size.width*0.04,),
                         Text("Application Status",style: TextStyle(fontSize:25,color: Colors.black),),
                       ...
                       Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: size.width*0.04,),
                         Text("User Management",style: TextStyle(fontSize:25,color: Colors.black),),
                     ...
                     SizedBox(height: size.height*0.05,),
                      Row(
                        ...
                        SizedBox(width: size.width*0.04,),
                         Text("Information",style: TextStyle(fontSize:25,color: Colors.black),),
         SizedBox(width: 120,),
